...
namespace GP.Petstar.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, Nombres = model.Nombres, ApPaterno = model.ApPaterno, ApMaterno = model.ApMaterno, Edad = model.Edad, PertenecesA = model.PertenecesA, Estatus = model.Estatus };
